  ...
  FILES.forEach(function (filename) {
    var req
      ...
      , options = {
          host: 'raw.github.com'
        , port: 443
        , path: path.join('/xbreaker/plusstrap/master/js/', filename)
        , method: 'GET'
        }
...
function js(params, callback) {
  ...
  try {
    ...
    min = 'Error minifying source - please open issue on http://github.com/xbreaker/plusstrap! thank you :)'
  }

  callback(null, {
    'js/plusstrap.js'    : new Buffer(content, 'utf8')
  , 'js/plusstrap.min.js': new Buffer(min, 'utf8')
  })
}
