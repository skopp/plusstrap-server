...
var path  = require('path')
  ...
  , ERROR = "A less error occured trying to build your bundle. Please paste the error below in an issue for us at http://github.com/xbreaker/plussrap! thanks!\n\n"
  ...
  FILES.forEach(function (filename) {
    var req
      ...
      , options = {
          host: 'raw.github.com'
        , port: 443
        , path: path.join('/xbreaker/plussrap/', BRANCH, '/less/', filename)
        , method: 'GET'
        }
